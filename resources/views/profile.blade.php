...
<section class="section-padding section-bg" id="section_2">
    <div class="container">         
        <img src="{{ asset('images/pages/webiner.jpg')}}" class="custom-text-box-image" height="100px" alt="">
    </div>
</section>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-6 col-md-5 col-12">
				<img src="{{ asset('images/barcode.jpg')}}" class="about-image ms-lg-auto bg-light shadow-lg img-fluid" alt="">
			</div>
